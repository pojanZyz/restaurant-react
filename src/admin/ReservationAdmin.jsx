      ...
      <div className="reservation-admin-container quicksand">
        <div className="admin-reserv-con1">
          <h2 className="poppins-regular">
            <i className="bi bi-calendar-check judul"></i> <span className="judul">Reservations</span>
          </h2>
        </div>

        <div className="admin-reserv-con2">
          <div className="control-panel-admin control-panel-admin-reserv">
            ...
            <div className="controlpanel-extend control-panel-extend-reserv">
              <button
                className={
                  resStatus === ""
          ...
          {reservationCount === 0 ? (
            ...
            <>
              ...
              <div className="reserv-table-container">
